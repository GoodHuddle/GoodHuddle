...
public class CreateSubscriptionRequest {
    ...
    public CreateSubscriptionRequest(PaymentType type, SubscriptionFrequency frequency,
                                     String token, int amountInCents, String currency, String email, String description) {
        this.type = type;
