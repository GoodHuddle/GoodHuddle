...
@Service
public class SecurityGroupRefBuilder extends AbstractDTOBuilder<SecurityGroupRef, SecurityGroup> {

    @Override
    protected SecurityGroupRef buildNullSafe(SecurityGroup entity) {
        return new SecurityGroupRef(
                entity.getId(),
                entity.getName(),
