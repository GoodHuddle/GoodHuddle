...
package com.goodhuddle.huddle.web.builder.member.tag;
...
@Service
public class TagDetailBuilder extends AbstractDTOBuilder<TagDetail, Tag> {

    @Override
    protected TagDetail buildNullSafe(Tag entity) {
